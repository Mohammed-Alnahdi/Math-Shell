...
static const char *dmenucmd[] = { "dmenu_run","-l","20", "-p", "Run: ", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", font_dmenu, NULL };
static const char *termcmd[]  = { "st", NULL };
static const char *cmdprintscreen[] = { "scrot", "/home/mohammed/Pictures/screenshots/%Y-%m-%d-%s_$wx$h.jpg", NULL };
...
static const char *call_emacs[] = { "emacs", NULL };
...
static Button buttons[] = {
	...
	{ ClkButton,		0,		Button1,	spawn,		{.v = call_emacs } },
